...
#include "../BACKTRACK/Backtracking.h"
...
namespace FEATURES
{
	namespace RAGEBOT
	{
		...
		private:
			...
			bool get_multipoints(SDK::CBaseEntity* entity, int ihitbox, std::vector<Vector>& points, const matrix3x4_t mx[], float force_pointscale);
