...
#include "../MISC/FEATURES/SKINCHANGER/SkinChanger.h"

#include "../../FRONTEND/PPGUI.h" // PPGUI Framework/PPGUI.h
...
namespace SETTINGS
{
	...
	public:
		...
		int aimbot_delay_shot_type = 0;
		float aimbot_delay_shot = 0.f;

		int aimbot_accuracy_type = 0;
		float aimbot_accuracy = 0.f;

		bool aimbot_selected_multipoint_hitgroups[5];
		bool aimbot_selected_hitgroups[5];
		float aimbot_hitscan_pointscale = 0.f;
		bool aimbot_duel_multipoint_enabled = false;
		float aimbot_duel_multipoint_pointscale = 0.f;

		bool aimbot_resolver_switch = false;

		bool backtrack_all_ticks = false;

		/* PINGSPIKE */
		int fake_latency = 0;
		int fake_latency_keybind = -1;
		float fake_latency_amount;
	};
