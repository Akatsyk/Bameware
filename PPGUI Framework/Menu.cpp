...
namespace PPGUI
{
	namespace MENU
	{
		void Do()
		{
			...
			/// Main window
			PPGUI_BeginWindow("Bameware", HELPERS::PPGUI_Vector2D(200, 200), HELPERS::PPGUI_Vector2D(800, 550), 2);
			{
				/// Main tabs
				...
				{					
					...
					PPGUI_BeginGroupbox("Aimbot", 435);
					{
						if (PPGUI_Checkbox("Enabled##aimbot enabled", SETTINGS::ragebot_configs.aimbot_enabled, false))
						{
							...
							static char ignore_types[][PPGUI_MAX_STRING_LENGTH] =
							{
								"Disabled",
								"Enable",
								"On Key",
							...
							PPGUI_Combobox("Ignore", 5, ignore_types, SETTINGS::ragebot_configs.aimbot_ignore_head_type, false);
							PPGUI_AttachToPreviousWidget();
							PPGUI_Keybind("##head", SETTINGS::ragebot_configs.aimbot_ignore_head_keybind, false);
							PPGUI_Checkbox("Ignore limbs when moving", SETTINGS::ragebot_configs.aimbot_ignore_limbs_when_moving, false);
							PPGUI_SameLine();
							PPGUI_Checkbox("Auto Crouch", SETTINGS::ragebot_configs.aimbot_autocrouch_enabled, false);

							static char autostop_types[][PPGUI_MAX_STRING_LENGTH] =
							{
								"Disabled",
								"Enabled",
							};
							...
							PPGUI_Slider("Bodyaim if x damage", "dmg", 0.f, 110.f, SETTINGS::ragebot_configs.aimbot_bodyaim_if_x_damage, 0, false);
							...
							PPGUI_Checkbox("Duel body point-scale", SETTINGS::ragebot_configs.aimbot_duel_multipoint_enabled, false);
							if (SETTINGS::ragebot_configs.aimbot_duel_multipoint_enabled == 1)
							{
								PPGUI_Slider("Duel body point-scale", "%", SETTINGS::ragebot_configs.aimbot_hitscan_pointscale, 110.f, SETTINGS::ragebot_configs.aimbot_duel_multipoint_pointscale, 0, false);
							}
							else
							{
								PPGUI_Disable();
							...
							static char delay_shot_types[][PPGUI_MAX_STRING_LENGTH] =
							{
								"Damage",
								"Resolved",
							};
							PPGUI_Combobox("Delay shot type", 2, delay_shot_types, SETTINGS::ragebot_configs.aimbot_delay_shot_type, false);
							PPGUI_Slider("Delay shot", "s", 0.f, 0.5f, SETTINGS::ragebot_configs.aimbot_delay_shot, 2, false);


							static char fake_latency_types[][PPGUI_MAX_STRING_LENGTH] =
							{
								"Disabled",
								"Enabled",
							};

							PPGUI_Combobox("Fake latency", 2, fake_latency_types, SETTINGS::ragebot_configs.fake_latency, false);

							if (!SETTINGS::ragebot_configs.fake_latency)
							{
								PPGUI_AlphaModulate(0.2f);
								PPGUI_Disable();
								PPGUI_Slider("##latency amount", "ms", 0.f, 1000.f, SETTINGS::ragebot_configs.fake_latency_amount, 0, false);
							}
							if (SETTINGS::ragebot_configs.fake_latency == 1 || SETTINGS::ragebot_configs.fake_latency == 2)
								PPGUI_Slider("##latency amount", "ms", 0.f, 1000.f, SETTINGS::ragebot_configs.fake_latency_amount, 0, false);
							...
							PPGUI_MultiselectCombobox("Hitscan multipoint groups", 5, hitscan_items, SETTINGS::ragebot_configs.aimbot_selected_multipoint_hitgroups, false);
					...
					PPGUI_BeginGroupbox("Anti-aim", 300);
					{
				...
				case 2: /// Visuals
				{
					...
					PPGUI_BeginGroupbox("Other##visuals other", 270);
					{
						...
						PPGUI_Separator("Misc##visuals other misc", false);
						{
							...
							{
								PPGUI_AttachToPreviousWidget();
								PPGUI_ColorPicker("##spread circle color",
									SETTINGS::main_configs.spread_circle_color.RGBA[0],
							...
							{
								PPGUI_AttachToPreviousWidget();
								PPGUI_ColorPicker("##bullet tracers color",
									SETTINGS::main_configs.bullet_tracers_color.RGBA[0],
							...
							{
								PPGUI_AttachToPreviousWidget();
								PPGUI_ColorPicker("##snaplines color",
									SETTINGS::main_configs.snaplines_color.RGBA[0],
							...
							{
								PPGUI_AttachToPreviousWidget();
								PPGUI_ColorPicker("##grenade tracers color",
									SETTINGS::main_configs.grenade_tracers_color.RGBA[0],
							...
							{
								PPGUI_AttachToPreviousWidget();
								PPGUI_ColorPicker("##no scope overlay color",
									SETTINGS::main_configs.no_scope_overlay_color.RGBA[0],
					...
					PPGUI_BeginGroupbox("World Modifications##visuals world textures", 60);
					{
						...
						PPGUI_SameLine();
						if (PPGUI_Button("World Update", false))
							FEATURES::VISUALS::world_textures.disconnect = true;

					}PPGUI_EndGroupbox();

					PPGUI_BeginGroupbox("Backtrack visualization", 70);
					{
						if (PPGUI_Checkbox("Skeleton##backtrack skeleton enabled", SETTINGS::main_configs.bt_vis_skeleton_enabled, false))
						{
							PPGUI_AttachToPreviousWidget();
							PPGUI_ColorPicker("##backtrack skeleton color",
								SETTINGS::main_configs.bt_vis_skeleton_color.RGBA[0],
						...
						if (PPGUI_Checkbox("Chams##backtrack chams enabled", SETTINGS::main_configs.bt_vis_chams_enabled, false))
						{
							PPGUI_AttachToPreviousWidget();
							PPGUI_ColorPicker("##backtrack chams color",
								SETTINGS::main_configs.bt_vis_chams_color.RGBA[0],
						...
						if (PPGUI_Checkbox("Dot##backtrack dot enabled", SETTINGS::main_configs.bt_vis_dot_enabled, false))
						{
							PPGUI_AttachToPreviousWidget();
							PPGUI_ColorPicker("##backtrack dot color",
								SETTINGS::main_configs.bt_vis_dot_color.RGBA[0],
					...
					PPGUI_BeginGroupbox("ESP##visuals esp", 210);
					{
						...
						{
							PPGUI_AttachToPreviousWidget();
							PPGUI_ColorPicker("##enemy box esp color",
								SETTINGS::main_configs.esp_enemy_box_color.RGBA[0],
						...
						{
							PPGUI_AttachToPreviousWidget();
							PPGUI_ColorPicker("##enemy skeleton esp color",
								SETTINGS::main_configs.esp_enemy_skeleton_color.RGBA[0],
						...
						{
							PPGUI_AttachToPreviousWidget();
							PPGUI_ColorPicker("##enemy name esp color",
								SETTINGS::main_configs.esp_enemy_text_color.RGBA[0],
						...
						{
							PPGUI_AttachToPreviousWidget();
							PPGUI_ColorPicker("##team box esp color",
								SETTINGS::main_configs.esp_team_box_color.RGBA[0],
						...
						{
							PPGUI_AttachToPreviousWidget();
							PPGUI_ColorPicker("##team skeleton esp color",
								SETTINGS::main_configs.esp_team_skeleton_color.RGBA[0],
						...
						{
							PPGUI_AttachToPreviousWidget();
							PPGUI_ColorPicker("##team name esp color",
								SETTINGS::main_configs.esp_team_text_color.RGBA[0],
					...
					PPGUI_BeginGroupbox("Player textures", 320);
					{
						...
						if (PPGUI_Checkbox("Draw chams##draw chams localplayer", SETTINGS::main_configs.chams_local_enabled, false))
						{
							...
							PPGUI_AttachToPreviousWidget();
							PPGUI_ColorPicker("##localplayer chams color",
								SETTINGS::main_configs.chams_local_color.RGBA[0],
								SETTINGS::main_configs.chams_local_color.RGBA[1],
								SETTINGS::main_configs.chams_local_color.RGBA[2],
