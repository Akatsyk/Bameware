...
namespace FONTS
{
	...
	void InitFonts()
	{
		...
		visuals_esp_font = RENDER::CreateF("Tahoma", 12, FW_MEDIUM, 0, 0, SDK::FONTFLAG_ANTIALIAS | SDK::FONTFLAG_DROPSHADOW); // Tahoma //Calibri, 11, 500, outline
		visuals_esp_font_small = RENDER::CreateF("Small Fonts", 8, FW_NORMAL, 0, 0, SDK::FONTFLAG_OUTLINE);
