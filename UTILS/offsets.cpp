...
namespace OFFSETS
{
	...
	void InitOffsets()
	{
		...
		m_bDormant = 0xE9;
		animstate = 0x3874;
		m_vecViewOffset = 0x104; //0x104 //102, 103, 104
		m_dwBoneMatrix = 0x2698;
		m_aimPunchAngle = 0x301C;
		dwGlowObjectManager = 0x4FB2540;
		ClientState = 0x57B7EC;
		m_MoveType = 0x258;
		m_hViewModel = 0x32DC;

		//DT_CSPlayer m_vecViewOffset[0] //No doesn't work
		//m_vecViewOffset = UTILS::netvar_manager.GetOffset(enc_char("DT_CSPlayer"), enc_char("m_vecViewOffset[0]"));
		...
		m_ArmorValue = UTILS::netvar_manager.GetOffset(enc_char("DT_BasePlayer"), enc_char("m_ArmorValue"));
