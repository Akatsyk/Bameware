...
namespace SDK
{
	...
	public:
		...
		void GetModelMaterials(const model_t* model, int count, IMaterial** ppMaterial)
		{
			...
			VMT::GetVFunction<Fn>(this, 19)(this, model, count, ppMaterial);
		}
	};
}
