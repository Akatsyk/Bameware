...
namespace SDK
{
	...
	public:
		void SetMaterialVarFlag(MaterialVarFlags_t flag, bool on)
		{
			...
			return VMT::GetVFunction<OriginalFn>(this, 29)(this, flag, on);
		}

		bool GetFlag(int fl) 
		{
			return VMT::GetVFunction<bool(__thiscall*)(void*, int)>(this, 30)(this, fl);
		}

		void GetReflectivity(Vector& reflect)
		{
			typedef void (__thiscall* Fn)(void*, Vector&);
			return VMT::GetVFunction<Fn>(this, 31)(this, reflect);
		}

		void AlphaModulate(float alpha)
		{
			typedef void (__thiscall* Fn)(void*, float);
			return VMT::GetVFunction<Fn>(this, 27)(this, alpha);
		}

		void ColorModulate(float r, float g, float b)
		{
			typedef void (__thiscall* Fn)(void*, float, float, float);
			return VMT::GetVFunction<Fn>(this, 28)(this, r, g, b);
		}

		void ColorModulate(CColor color)
		{
			typedef void (__thiscall* Fn)(void*, float, float, float);
			return VMT::GetVFunction<Fn>(this, 28)(this, color.RGBA[0] / 255.f, color.RGBA[1] / 255.f, color.RGBA[2] / 255.f);
		}

		const char* GetTextureGroupName()
		{
			typedef const char*(__thiscall* oGetTextureGroupName)(void*);
			return VMT::GetVFunction<oGetTextureGroupName>(this, 1)(this);
		}

		const char* GetMaterialName()
		{
			typedef const char*(__thiscall* oGetName)(void*);
			return VMT::GetVFunction<oGetName>(this, 0)(this);
		}

		void SetShader(const char* pShaderName)
		{
			typedef void (__thiscall* SetShaderFn)(void*, const char* pShaderName);
			VMT::GetVFunction<SetShaderFn>(this, 34)(this, pShaderName);
		}
		...
		{
			typedef void (__thiscall *Fn)(void*);
			return VMT::GetVFunction<Fn>(this, 13)(this);
		}

		float GetAlphaModulation()
		{
			typedef float (__thiscall* Fn)(void*);
			return VMT::GetVFunction<Fn>(this, 44)(this);
		}
		...
		void GetColorModulation(float* red, float* green, float* blue)
		{
			///45
			typedef void (__thiscall* Fn)(void*, float*, float*, float*);
			VMT::GetVFunction<Fn>(this, 45)(this, red, green, blue);
		}
	};
